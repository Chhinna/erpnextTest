    ...
    if chart:
        ...
        def _import_accounts(children, parent, root_type, root_account=False):
            for account_name, child in children.items():
                ...
                if account_name in {"account_name", "account_number", "account_type", "root_type", "is_group", "tax_rate", "account_currency"}:
                    continue
...
def identify_is_group(child):
    ...
    if len(
        set(child.keys())
        - {"account_name", "account_type", "root_type", "is_group", "tax_rate", "account_number", "account_currency"}
    ):
        return 1
    return 0
