...
class ExchangeRateRevaluation(Document):
    ...
    def check_journal_entry_condition(self):
        ...
        if journals:
            ...
            return total_amt and total_amt[0][0] != self.total_gain_loss
    ...
    def get_account_balance_from_gle(
        ...
        if company and posting_date:
            ...
            if accounts:
                ...
                # conditions
                conditions = [gle.account.isin(accounts), gle.posting_date.lte(posting_date), gle.is_cancelled == 0]
...
def calculate_exchange_rate_using_last_gle(company, account, party_type, party):
    ...
    if company and account:
        ...
        # build conditions
        conditions = [gl.company == company, gl.account == account, gl.is_cancelled == 0, (gl.debit > 0) | (gl.credit > 0), (gl.debit_in_account_currency > 0) | (gl.credit_in_account_currency > 0)]
        if party_type:
